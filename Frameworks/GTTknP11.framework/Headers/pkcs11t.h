...
typedef uint32_t /*unsigned long int*/ CK_ULONG;

/* a signed value, the same size as a CK_ULONG */
/* CK_LONG is new for v2.0 */
typedef int32_t /*long int*/          CK_LONG;
...
/* Non-standard CKM_ECDSA_SHA224 */
#define CKM_ECDSA_SHA224               0x00001043
/* Non-standard CKM_ECDSA_SHA256 */
...
#define CKK_CUSTOM					(CKK_VENDOR_DEFINED + 0x40000001)
#define CKM_CUSTOM_KEY_GEN			(CKM_VENDOR_DEFINED + 0x40000001)
#define CKM_CUSTOM_ECB				(CKM_VENDOR_DEFINED + 0x40000002)
#define CKM_CUSTOM_CBC				(CKM_VENDOR_DEFINED + 0x40000003)
//#define CKM_CUSTOM_CBC_PAD		(CKM_VENDOR_DEFINED + 0x40000004)
//#define CKM_CUSTOM_ECB_PAD		(CKM_VENDOR_DEFINED + 0x40000005)


// Software algorithms
// S/W AES
#define CKM_AES_ECB_SW				(CKM_VENDOR_DEFINED | CKM_AES_ECB)
#define CKM_AES_CBC_SW				(CKM_VENDOR_DEFINED | CKM_AES_CBC)
#define CKM_AES_CBC_PAD_SW			(CKM_VENDOR_DEFINED | CKM_AES_CBC_PAD)

// S/W DES
#define CKM_DES_ECB_SW				(CKM_VENDOR_DEFINED | CKM_DES_ECB)
#define CKM_DES_CBC_SW				(CKM_VENDOR_DEFINED | CKM_DES_CBC)
#define CKM_DES_CBC_PAD_SW			(CKM_VENDOR_DEFINED | CKM_DES_CBC_PAD)
#define CKM_DES3_ECB_SW				(CKM_VENDOR_DEFINED | CKM_DES3_ECB)
#define CKM_DES3_CBC_SW				(CKM_VENDOR_DEFINED | CKM_DES3_CBC)
#define CKM_DES3_CBC_PAD_SW			(CKM_VENDOR_DEFINED | CKM_DES3_CBC_PAD)



//SSL
#define CKM_TLS_PRF_GENERAL (CKK_VENDOR_DEFINED + 0x373) //const define
